...
//                     ]);
        ...
        // country brazil
        $country = \LeadStore\Framework\Models\Database\Country::where('code', '=', 'br')->first();
        ...
        if ($country) {
            ...
            foreach ($estadosBrasileiros as $code => $name) {
                \LeadStore\Framework\Models\Database\State::create(['code' => $code, 'name' => $name, 'country_id' => $country->id]);
            }
        }
